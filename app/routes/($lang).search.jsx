...
export default function Search() {
  ...
  return (
    <>
      <PageHeader>
        <Heading as="h1" size="copy" className='text-white'>
          Search
        </Heading>
        <Form method="get" className="relative flex w-full text-heading border-b-2 text-white">
          <Input
      ...
      {!searchTerm || noResults ? (
        <>
          {noResults && (
            <Section padding="x" className='text-white'>
