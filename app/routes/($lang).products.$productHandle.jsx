...
export default function Product() {
  ...
  return (
    <>
      <Section className="px-0 md:px-8 lg:px-12 lg:py-0">
        <div className="grid items-start md:gap-6 lg:gap-20 md:grid-cols-2">
          ...
          <div className="sticky md:-mb-nav md:top-nav md:-translate-y-nav md:h-screen md:pt-nav hiddenScroll md:overflow-y-scroll">
            <section className="flex flex-col w-full max-w-xl gap-8 p-6 mx-auto md:px-0">
              <div className="grid gap-2 text-white pt-12">
    ...
    <>
      {options
        ...
        .map((option) => (
          ...
          >
            <Heading as="legend" size="lead" className="min-w-[4rem] text-white">
              {option.name}
            </Heading>
                    ...
                    return (
                      <Text key={id}>
                        <ProductOptionLink
                          ...
                          searchParams={searchParamsWithDefaults}
                          className={clsx(
                            'leading-none py-1 border-b-[1.5px] text-white cursor-pointer transition-all duration-200',
