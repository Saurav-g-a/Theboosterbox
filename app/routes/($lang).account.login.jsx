...
export default function Login() {
  ...
  return (
    <div className="flex justify-center  rounded-[10px]4 px-4 translate-y-1/3	">
      <div className="max-w-md w-full">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <button
              className="bg-[#f9f9f94d] text-[#111827] rounded-[10px] border-[#f9f9f999] border-2 py-2 px-4 focus:shadow-outline block w-full"
              type="submit"
          ...
          <div className="flex justify-between items-center mt-8 border-t border-gray-300 text-white">
            <p className="align-baseline text-base mt-6">
              New to The Booster Box? &nbsp;
              <Link className="inline text-[#f9f9f9cc]" to="/account/register">
                Create an account
              </Link>
            </p>
            <Link
              className="mt-6 inline-block align-baseline text-base underline text-primary/50 text-white"
              to="/account/recover"
            >
              Forgot password
            </Link>
