...
export function OrderCard({order}) {
  ...
  return (
    <li className="grid text-center border rounded text-white">
      <Link
      ...
      >
        ...
        >
          ...
          <dl className="grid grid-gap-1 ">
            <dt className="sr-only text-white">Order ID</dt>
            <dd>
              <Text size="fine" color="white">
                Order No. {order.orderNumber}
              </Text>
            </dd>
            <dt className="sr-only text-white">Order Date</dt>
            <dd>
              <Text size="fine" color="white">
      ...
      <div className="self-end border-t">
        <Link
          ...
          prefetch="intent"
        >
          <Text color="white" className="ml-3">
            View Details
          </Text>
        </Link>
      </div>
