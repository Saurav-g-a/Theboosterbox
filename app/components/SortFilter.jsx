...
export default function SortMenu() {
  ...
  return (
    <Menu as="div" className="relative z-40">
      <Menu.Button className="flex items-center text-white border-2 border-white rounded-[10px] p-2">
        <span className="px-2">
      ...
      <Menu.Items
        as="nav"
        className="absolute text-white right-0 flex flex-col p-4 text-right rounded-sm bg-liner"
      >
        {items.map((item) => (
