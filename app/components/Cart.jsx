    ...
    <>
      ...
      <UpdateDiscountForm>
        ...
        >
          ...
          />
          <button className="flex justify-end font-medium whitespace-nowrap text-white">
            Apply Discount
          </button>
        </div>
      </UpdateDiscountForm>
...
function CartLines({layout = 'drawer', lines: cartLines}) {
  ...
  return (
    <section
      ...
      className={className}
    >
      <ul className="grid gap-6 md:gap-10 text-white">
...
function CartSummary({cost, layout, children = null}) {
  ...
  return (
    <section aria-labelledby="summary-heading" className={summary[layout]}>
      <h2 id="summary-heading" className="sr-only text-white">
        Order summary
      </h2>
      <dl className="grid text-white">
    ...
    <li key={id} className="flex gap-4">
      ...
      <div className="flex justify-between flex-grow">
        <div className="grid gap-2">
          ...
          <div className="grid pb-2 text-white">
            {(merchandise?.selectedOptions || []).map((option) => (
              <Text color="white" key={option.name}>
      ...
      <div className="flex items-center border rounded">
        <UpdateCartButton lines={[{id: lineId, quantity: prevQuantity}]}>
          <button
            ...
            className="w-10 h-10 transition text-white hover:text-white disabled:text-white"
            value={prevQuantity}
            disabled={quantity <= 1}
          >
            <span>&#8722;</span>
        ...
        <UpdateCartButton lines={[{id: lineId, quantity: nextQuantity}]}>
          <button
            className="w-10 h-10 transition text-white hover:text-white"
...
export function CartEmpty({hidden = false, layout = 'drawer', onClose}) {
  ...
  return (
    <div ref={scrollRef} className={container[layout]} hidden={hidden}>
      <section className="grid gap-6 text-white backroundss">
        <Text format>
